...
def run_task(*_):
    ...
    #requires GaussianMLPPolicy

    #env = normalize(GymEnv("FrozenLake-v0"))

    #env = normalize(GymEnv("Taxi-v2"))

    env = normalize(GymEnv("GuessingGame-v0"))
    #requires GaussianMLPPolicy w

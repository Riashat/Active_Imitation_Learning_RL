...
class DDPG(RLAlgorithm):
    ...
    def init_opt(self):
        ...
        My edits
        """
        # qf_input_list_oracle = [yvar_oracle, obs_oracle, action_oracle]
        # policy_input_list_oracle = [obs_oracle]

        # self.qf_update_method.update_opt(
        #     loss=qf_reg_loss_oracle, target=self.qf, inputs=qf_input_list_oracle)


        # gf_input_list = [obs_oracle, action_oracle, yvar_oracle] + policy_input_list_oracle + qf_input_list_oracle
